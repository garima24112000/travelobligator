...
class ErrorCode(str, Enum):
    ...
    # Section 202B.1: honest, distinct outcomes the 202A baseline showed
    # were being collapsed into "REGENERATION_NOT_AVAILABLE".
    REGENERATION_FEEDBACK_NOT_INTERPRETABLE = "REGENERATION_FEEDBACK_NOT_INTERPRETABLE"
    REGENERATION_NO_EFFECT = "REGENERATION_NO_EFFECT"
    REGENERATION_PROVIDER_RATE_LIMITED = "REGENERATION_PROVIDER_RATE_LIMITED"
    # The AI feedback INTERPRETER could not produce a usable result (not
    # connected / auth / timeout / provider error / malformed output).
    # Distinct from REGENERATION_PROVIDER_UNAVAILABLE, which means a
    # requested PLACE could not be looked up with the places provider.
    REGENERATION_AI_UNAVAILABLE = "REGENERATION_AI_UNAVAILABLE"
